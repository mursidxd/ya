...
conn.sendPresenceUpdate('composing', m.chat)
  ...
  let arrayMenu = ['all', 'berita', 'game', 'rpg', 'xp', 'stiker', 'kerangajaib', 'quotes', 'admin', 'grup', 'premium', 'fitnah', 'asupan', 'internet', 'anonymous', 'anime', 'nulis', 'downloader', 'film', 'cerita', 'jadwal', 'tools', 'fun', '18+', 'vn', 'database', 'quran', 'audio', 'jadibot', 'info', 'tanpakategori', 'err', 'owner']
	 ...
	 const sections = [
      ...
      },
      {
        ...
        rows: [
          ...
          { title: 'Berita', rowId: `${_p + command} berita`, description: `Anda Berminat Untuk Melihat Berita Harian Di negara tercinta ini ?`},          
